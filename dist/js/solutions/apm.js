	...
	function Tab(){
	  $('ul').click(function(){
	    ...
	    if($(this).children().hasClass('on')){
	      ...
	      $(this).css('background-color','#fff').siblings().css('background-color','#FAFAFA');
	      $(this).children('li').slideDown(500).addClass('on');
	      $(this).siblings().children('li').stop().slideUp(500).removeClass('on');
	      $('.tab-img img').eq(_index).show().siblings().hide();
	    }
	  });
	}
	Tab();
